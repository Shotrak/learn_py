...
logging.basicConfig(level=logging.INFO, filename="/sambashare/share/dev/py3/py_log.log",filemode="w",format="%(asctime)s %(levelname)s %(message)s") #Каждое выполнение затирает файл, пофиксить
